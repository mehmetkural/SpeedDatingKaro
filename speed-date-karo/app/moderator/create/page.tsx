  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white p-4">
      <div className="max-w-md mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 bg-gray-800 p-6 rounded border border-gray-700">
          <div>
            <label className="block text-sm font-bold mb-2 text-gray-300">Etkinlik Adı</label>
            <input
              type="text"
              value={title}
          ...
          <div>
            <label className="block text-sm font-bold mb-2 text-gray-300">Süre (dakika)</label>
            <select
              value={duration}
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-green-500 to-green-600 text-white p-3 rounded hover:from-green-600 hover:to-green-700 disabled:opacity-50 disabled:cursor-not-allowed font-bold transition shadow-lg"
          >
